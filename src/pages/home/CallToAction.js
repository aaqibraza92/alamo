...
>>>>>>> c6a4cec51c0ad5e7e340bed0fe1f690718f88e2b
      ...
      <h2 className="colorWhite fs50 fw600 mb60 mobMb30">
        ...
        <div className="d-flex justify-content-center align-items-center flex-wrap">
          <Link className="btnBorder btnTheme fs20 fw500 bgGreen mr15 mb15 fMedium btnMob pt20 pb20 pl30 pr30" to="#">
            New-Patient-Registration 
          </Link>
          <Link className="btnTheme borderGreen fs20 fw500 bgGreen mb15  fMedium btnMob pt20 pb20 " to="#">
            Book Appointment
          </Link>
        </div>
      </div>
