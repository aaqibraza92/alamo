...
<Container>
    ...
    <Col lg={12} md={12}>
        ...
        <div className="pb-3">
          ...
          <p className="fs16 text-white fw400 tabfs15 mobFs15  text-justify">Dr. Vishal Nemarugommula truly believes that “Health and Wellness are like two hands that have to clap together to make music. Medicine will be prime to empower patients and help them achieve their health objectives and goals at every stage and age in life”</p>
          <p className="fs16 text-white fw400 tabfs15 mobFs15  text-justify">Dr. Vishal Nemarugommula, in his free time, loves to travel, play tennis, spend time with his family, and his 2 boys, and cook. </p>
